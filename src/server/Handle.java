...
//	private String X_REQUEST = "TenHang";
...
//	public String checkVX(String nameVX) {
//		String kq = "";
//		Connection conn = mConnect.getConnectMySQL();
//		String sql = "SELECT "+X_REQUEST+" FROM "+X_TABLE+" WHERE "+X_CONDITION+" = ? LIMIT 1";
//		try {
...
//		if(new Handle().checkVX("Vắc xin A").equals("")){
//			System.out.println("Không tìm thấy Vắc xin này!");
//		}else{
//			System.out.println(new Handle().checkVX("Vắc xin A"));
//		}
//	}
}
